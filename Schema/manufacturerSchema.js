...
//         ),
//         gstCertificate: z.string()
//         .refine((id)=>ObjectId.isValid(id),{message:"Invalid gridfs objectId"}),

//     manufacturingLicenseNumber: z
//         .string()
//         .min(1, { message: "Manufacturing license number is required" }),
//     manufacturingLicenseCertificate:z.string()
//     .refine((id)=>ObjectId.isValid(id),{message:"Invalid gridfs objectId"}),
//     panNumber: z
//         .string()
//         .regex(
